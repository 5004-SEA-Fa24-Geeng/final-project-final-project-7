...
* What are the *minimum* additional features you plan to implement?
  * Ability to select player roster for opposing team.
...
* How do you plan to break up the work?
  ...
  * Max and Vincent will handle Model and business logic implementation and testing.
* What is your teams timeline and major check-in points?
  * Week 1: Complete design and product roadmap
  * Week 2: MVP complete with initial features implemented and tested
  * Week 3: Implement stretch goal features (time permitting) and introduce any optimizations/refactoring as necessary
  * Week 4: Complete documentation, testing, and presentation of the product.
