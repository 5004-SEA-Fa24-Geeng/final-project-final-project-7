 ...
 * 
 * // Set up manual mocks
 * playerStub1 = new MockPlayer("Mike Trout",
 * "Mike Trout | AVG: .312 | HR: 42 | RBI: 104");
 * playerStub2 = new MockPlayer("Julio Rodriguez",
 * "Julio Rodriguez | AVG: .289 | HR: 32 | RBI: 91");
 * 
 * List<PlayerStub> players = Arrays.asList(playerStub1, playerStub2);
 * teamStub = new MockTeam("Mariners", players,
 * "Wins: 92\nLosses: 70\nTeam AVG: .258\nTeam ERA: 3.75");
 * 
 ...
 * 
 * // Assert
 * assertEquals("Mike Trout | AVG: .312 | HR: 42 | RBI: 104" +
 ...
 * // Arrange
 * TeamStub emptyTeam = new MockTeam("Empty Team", new ArrayList<>(),
 * "No stats available");
 * 
 * // Act
 ...
 * TextUI localTextUI = new TextUI(); // Need a new instance with the new
 * System.in
 * 
 * // Act
 ...
 * 
 * // Assert
 * assertEquals("ERROR: Invalid command" + System.lineSeparator(),
 * outContent.toString());
 * }
 * 
 ...
 * 
 * public MockSimulationResult(int marinersScore, int opponentScore, String
 * details) {
