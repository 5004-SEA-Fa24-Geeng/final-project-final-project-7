...
public class TextUI {
    ...
    public void displayHelp() {
        ...
        System.out.println("  player show attributes    - Show filterable attributes");
        ...
        System.out.println("  computer show attributes    - Show filterable attributes");
    ...
    /**
     * Generically displays a numbered list of strings
     * @param strings the list of strings to display
     */
    public void displayListOfStrings(List<String> strings) {
